            ...
            <div className="relative z-20 w-full max-w-[1600px] mx-auto px-6 md:px-12">
                <div className="max-w-3xl animate-in fade-in slide-in-from-bottom-8 duration-1000">
                    ...
                    <div className="flex flex-col md:flex-row gap-4 md:gap-6 items-start md:items-center">
                        <p className="text-white/80 text-base md:text-lg font-light max-w-[450px] leading-relaxed">
                            Explore our portfolio of exceptional interior design projects that showcase our commitment to excellence.
                        </p>
                    </div>
                </div>
            </div>

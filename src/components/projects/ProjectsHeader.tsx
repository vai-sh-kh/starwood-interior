    ...
    return (
        <header className="relative w-full h-[80vh] min-h-[600px] flex flex-col justify-end pb-24">
            <div
                ...
                style={{
                    backgroundImage: `url("/images/home/projects-banner.jpeg")`,
                }}
            ></div>
            ...
            <div className="relative z-20 w-full max-w-[1600px] mx-auto px-6 md:px-12">
                <div className="max-w-3xl animate-in fade-in slide-in-from-bottom-8 duration-1000">
                    ...
                    <div className="flex flex-col md:flex-row gap-4 md:gap-6 items-start md:items-center">
                        <p className="text-white/80 text-[15px] md:text-base font-light max-w-[350px] leading-relaxed">
                            Explore our portfolio of exceptional residential and commercial projects, showcasing our dedication to quality and design.
                        </p>
                    </div>
                </div>
            </div>

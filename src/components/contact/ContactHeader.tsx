    ...
    return (
        <header className="relative w-full h-[80vh] min-h-[600px] flex flex-col justify-end pb-24">
            <div
                ...
                style={{
                    backgroundImage: `url("/images/home/contact-banner.jpeg")`,
                }}
            ></div>
                ...
                <div className="max-w-3xl animate-in fade-in slide-in-from-bottom-8 duration-1000">
                    ...
                    <div className="flex flex-col md:flex-row gap-4 md:gap-6 items-start md:items-center">
                        <p className="text-white/80 text-base md:text-lg font-light max-w-[350px] leading-relaxed">
                            Let's build your dream space together. Reach out to schedule a consultation or discuss your next project.
                        </p>
                    </div>
                </div>
            </div>

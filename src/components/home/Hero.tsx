...
export default function Hero() {
    ...
    return (
        <header className="relative w-full h-[80vh] md:min-h-[700px] flex flex-col justify-end pb-24 md:pb-24 overflow-hidden">
            {/* Background Slider */}
            ...
            <div className="relative z-20 w-full max-w-[1600px] mx-auto px-6 md:px-12">
                <div className="max-w-3xl animate-in fade-in slide-in-from-bottom-8 duration-1000">
                    ...
                    <div className="flex flex-col md:flex-row gap-4 md:gap-6 items-start md:items-center">
                        ...
                        <Link href="/contact">
                            <button className="bg-white text-black hover:bg-stone-200 border border-white px-6 py-3.5 md:px-10 md:py-4 text-xs md:text-xs uppercase tracking-widest font-semibold transition-all duration-300 min-h-[44px]">
